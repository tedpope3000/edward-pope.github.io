...
of (the 'in') this object (this thing changes depending on the object) { (and here's where you can say what to once you're in there)}. What I
most recently learned is that there's some behind-the-scenes stuff going on with these for loops. That's why you can just say (var key. . .) and
without assigning it a value. Anyways, say the object is called 'id' and it has all the key-value pairs a state ID card does. If you were to run 
a for-in loop on id, it would look like this:
*/
