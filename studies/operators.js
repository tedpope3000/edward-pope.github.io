...
function add(x, y) {
    return x + y;
} // in algebraic terms, that's the same as: function = x + y
  
console.log(5 % 2); // prints 1 since if you divide five by two, you have one left over
...
if(hasValidId === true && age >= 21 || theyHaveAreallyGoodFakeId === true) {
    return 'They can purchase alcohol';
}
