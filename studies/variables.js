...
* the possibility of accidental reassignment or miscall.
* 
* Using const provides the same protections, but the biggest difference is that const must be assigned
* a value immediately. With var and let, you can do something like this just to create a variable to be
